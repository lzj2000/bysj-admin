...
export default function RepairDialog({ visible, onCancel, selected }) {
    const repairDialog = useRef(null)
    useEffect(() => {
        repairDialog && repairDialog.current && repairDialog.current.setFieldsValue(selected);
    }, [selected])
    return (
        <>
            <Modal
